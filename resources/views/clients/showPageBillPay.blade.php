        ...
        <div class="col-md-6">
            <div class="bg-light p-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <small class="text-muted"><i
                                                class="bi bi-tag me-1"></i>{{ ucfirst($payment->payment_type) }}</small><br>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted"><i
                                                class="bi bi-clock me-1"></i>{{ $payment->created_at }}</small><br>
                                        @if ($payment->collected_by_id == $payment->created_by_id)
                                            <small class="text-muted"><i
                                                    class="bi bi-person me-1"></i>{{ $payment->collectedBy->name ?? 'N/A' }}</small>
                                        @else
                                            <small class="text-muted"><i
                                                    class="bi bi-person me-1"></i>{{ $payment->collectedBy->name ?? 'N/A' }}</small><br>
                                            <small class="text-muted"><i
                                                    class="bi bi-person me-1"></i>{{ $payment->createdBy->name ?? 'N/A' }}</small>
                                        @endif
                                        @if ($payment->remarks)
                                            <br>
                                            <small class="text-muted"><i
                ...
                <div class="mt-3 text-end">
                    <strong>Total Amount:</strong> {{ $totalAmount }} Taka
                </div>
            </div>
        </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <small class="text-muted"><i
                                                class="bi bi-person me-1"></i>{{ $bill->createdBy->name ?? 'N/A' }}</small>
                                        @if ($bill->remarks)
                                            <br>
                                            <small class="text-muted"><i
